...
void load_kernel_and_compute(FDATA_T* kernel, FDATA_T input_feature_map_reg[TILE_BATCH][FC_INPUT_SIZE],
    FDATA_T output_feature_map_reg[TILE_BATCH][FC_OUTPUT_SIZE]);


void compute(FDATA_T input_feature_map_reg[TILE_BATCH][FC_INPUT_SIZE], FDATA_T* kernel_reg,
            FDATA_T output_feature_map_reg[TILE_BATCH][FC_OUTPUT_SIZE], LDATA_T output_feature_map_index);

void load_input_feature_map(FDATA_T input_feature_map_reg[TILE_BATCH][FC_INPUT_SIZE],
...
void save_output_feature_map(FDATA_T output_feature_map_reg[TILE_BATCH][FC_OUTPUT_SIZE],
                            FDATA_T* bias,
...
template<>
void fc(FDATA_T* input_feature_map, FDATA_T* bias, FDATA_T kernel[FC_INPUT_SIZE * FC_OUTPUT_SIZE],
