...
char const * SIMPLE_RNN_RECURRENT_KERNEL_FILE = "simple_rnn_1_recurrent_kernel.txt";
...
char const * SIMPLE_RNN_RECURRENT_KERNEL_FILE = "../../model/simple_rnn_1_recurrent_kernel.txt";
