...
void float_softmax (float* input_feature_map,
...
void double_softmax (double* input_feature_map,
              double* output_probability_distribution) {
    /* please do INITIALIZATION before input output_feature_map */
    /* ------- DIMENSION SETTING  ---------- *
    ...
    for (int batch_index = 0; batch_index < SM_BATCH_SIZE; batch_index++) {
        ...
        for (int input_feature_map_index = 0; 
            ...
            /* compute it, cache it */
            input_feature_map_exp[input_feature_map_index] = 
                            exp(input_feature_map[current_input_feature_map_index]);
